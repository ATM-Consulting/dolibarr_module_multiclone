 ...
 */
class multiclonebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "multiclone@multiclone";
    public $boxlabel;
    public $depends = array("multiclone");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/multiclone/class/multiclone.class.php";
